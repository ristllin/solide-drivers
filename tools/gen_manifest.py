    ...
    return {
        ...
        "peripherals": {
            ...
            "speaker": {
                ...
                "pins": p["spk"],
                "volts": 3.3,
                "note": "amp needs the 5 V bus for volume",
            },
            "mic": {
                "namespace": "solide::audio",
                "bus": "I2S-PDM-RX (I2S0)",
            ...
            "display_tft": {
                ...
                "bus": "HSPI/SPI3 (shared with touch)",
                "pins": p["tft"],
                "volts": 3.3,
                "panel": "2.8in ILI9341 240x320 RGB565",
                "alternative_to": "display",
                "releases": "encoder",
            ...
            "touch": {
                ...
                "chip": "XPT2046",
                "bus": "HSPI/SPI3 (shared with display_tft)",
            ...
            "memory": {
                ...
                "backends": [
                    "NVS (typed key-value, <=15-char keys)",
        ...
        "power": {
            ...
            "rails": {
                "3v3": ["esp32-s3", "display", "sd", "audio board (amp + mic)"],
                "5v": ["led ring", "audio amp volume headroom"],
            },
        },
        "build": {
            "example": "SOLIDE_EXAMPLE=<name> pio run -e esp32s3 -t upload",
            "native_tests": "pio test -e native",
        },
        "serial_protocol": {
            "command": "TEST <led|epd|sd|memory|input|audio|all>",
